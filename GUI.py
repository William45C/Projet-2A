...
def draw_vignette(surface):
    ...
    pygame.draw.rect(vignette, (0, 0, 0, 50), (0, 0, WIDTH, HEIGHT), 20)
...
def render_game(player, evenement, cmd_text, donjon, current_state, TERMINAL_GREEN):
    ...
    display_buffer = pygame.Surface((WIDTH, HEIGHT))
    ...
    pygame.draw.line(display_buffer, TERMINAL_GREEN, (50, 60), (750, 60), 2)

    # 3. DRAW UI BOXES
    # Stats Box
    pygame.draw.rect(display_buffer, TERMINAL_GREEN, (500, 100, 250, 300), 2)
